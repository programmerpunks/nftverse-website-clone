  ...
  return (
    ...
    >
      <Image
        ...
        width={200}
        height={220}
        className="w-[19rem] h-auto absolute z-40 mt-[-17rem] rounded-lg"
      />
      <div
        className="flex flex-col backdrop-opacity-10 bg-[#9A9FA2]/20 
        border border-[#373737] rounded-lg w-full mt-28 z-30 p-8 pt-32 pb-10  hover:border-[#777777] cursor-pointer"
      >
